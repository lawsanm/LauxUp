 ...
 * No external dependency — all icons are inline SVG strings.
 */
 ...
 */
export function getIcon(name, size = 20, strokeWidth = 1.75) {
...
/**
 * Get an SVG icon as a DOM element.
 * @param {string} name
 * @param {number} size
 * @param {number} strokeWidth
 * @returns {Element}
 */
export function getIconElement(name, size = 20, strokeWidth = 1.75) {
  const wrapper = document.createElement('span');
  wrapper.className = 'mr-icon';
  wrapper.innerHTML = getIcon(name, size, strokeWidth);
  return wrapper;
}
